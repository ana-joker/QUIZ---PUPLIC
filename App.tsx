...
const translations = {
  en: {
    ...
    "apiKeyError": "API Key not found. Please ensure it is set in the environment variables.",
    ...
    "promptTooLongError": "The text is too long. Maximum {count} characters allowed.",
  ...
  ar: {
    ...
    "apiKeyError": "لم يتم العثور على مفتاح API. يرجى التأكد من إعداده في متغيرات البيئة.",
