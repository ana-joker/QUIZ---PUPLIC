...
export const BrainCircuitIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M19 12a7 7 0 1 0-14 0h14Z"/>
        <path d="M12 19a3 3 0 1 0-5.993-.142"/>
        <path d="M18 19a3 3 0 1 0-5.993-.142"/>
        <path d="M6 5a3 3 0 1 0 .142 5.993"/>
        <path d="M18 5a3 3 0 1 0 .142 5.993"/>
        <path d="M6 19a3 3 0 1 0 .142-5.993"/>
        <path d="M18 19a3 3 0 1 0 .142-5.993"/>
        <path d="M12 5v14"/>
        <path d="M12 12h7"/>
        <path d="M12 12H5"/>
    </svg>
...
export const Sparkles: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="m12 3-1.9 3.8-3.8 1.9 3.8 1.9 1.9 3.8 1.9-3.8 3.8-1.9-3.8-1.9L12 3z" />
        <path d="M5 13l-1.9 3.8-3.8 1.9 3.8 1.9 1.9 3.8 1.9-3.8 3.8-1.9-3.8-1.9L5 13z" />
        <path d="m22 7-1.9 3.8-3.8 1.9 3.8 1.9 1.9 3.8 1.9-3.8 3.8-1.9-3.8-1.9L22 7z" />
    </svg>
);
