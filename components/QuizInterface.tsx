            ...
            <body class="${settings.theme}">
                ...
                <script>
                    ...
                    function displayQuestion(index) {
                        ...
                        quizContentContainer.innerHTML = \`\${imageHTML}\${caseHTML}<div class="question-card p-6 rounded-lg"><p class="font-bold text-lg mb-4"> \${q.question}</p><div class="options space-y-3" data-question-index="\${index}">\${optionsHTML}</div><div id="feedback-area-\${index}" class="mt-4"></div></div>\`;
